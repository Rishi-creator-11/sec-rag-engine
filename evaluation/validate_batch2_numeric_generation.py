"""End-to-end numeric-year validation for Phase 5.5 Batch 2.

The lexical proxy in ``evaluate_multiyear_batch2`` requires the target number to
...
does NOT contain a wrong-year figure presented as that year's number.
    ...
    python -m evaluation.validate_batch2_numeric_generation
"""
...
OUT = REPO_ROOT / "evaluation" / "results" / "batch2_numeric_generation.json"
