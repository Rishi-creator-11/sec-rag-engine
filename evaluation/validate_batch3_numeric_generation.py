"""End-to-end numeric-year validation for Phase 5.5 Batch 3.

The lexical proxy in ``evaluate_multiyear_batch3`` requires the target number to
...
does NOT contain a wrong-year figure presented as that year's number.
    ...
    python -m evaluation.validate_batch3_numeric_generation
"""
...
OUT = REPO_ROOT / "evaluation" / "results" / "batch3_numeric_generation.json"
